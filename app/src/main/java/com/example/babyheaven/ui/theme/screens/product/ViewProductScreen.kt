...
import com.example.babyheaven.models.Product
import com.example.babyheaven.navigation.ROUTE_ADD_PRODUCT
import com.example.babyheaven.navigation.ROUTE_UPDATE_PRODUCTS
...
fun ProductItem(name:String, quantity:String, price:String, id:String,
    ...
    Column(modifier = Modifier.fillMaxWidth()) {
        ...
        Button(onClick = {
            navController.navigate(ROUTE_ADD_PRODUCT + "/$id")
        }){
            Text(text = "Back to Add Products")
